...
int Get_weight(void);             //prompt and store height routine
int Get_height(void);             //prompt and store height routine
int calc_BMI(int weight,int height);  //calculate bmi routine
int BMI_start(void);              //main bmi program
